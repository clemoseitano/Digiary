...
public class ScheduleDbAdapter {
    ...
    public boolean updateReminder(Long rowId, long nextevent) {
        ContentValues args = new ContentValues();
        args.put(KEY_DATE_TIME, nextevent);
     ...
     */
    public long createReminder(String title, String body, long reminderDateTime, long repeating) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_TITLE, title);
        initialValues.put(KEY_BODY, body);
        initialValues.put(KEY_REPEATING, repeating);
        initialValues.put(KEY_DATE_ADDED, System.currentTimeMillis());
    ...
    public Cursor fetchAllReminders() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_TITLE,
                KEY_BODY, KEY_DATE_TIME, KEY_DATE_ADDED, KEY_REPEATING}, null, null, null, null, null);
    }
    ...
    public Cursor fetchReminder(long rowId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                        KEY_TITLE, KEY_BODY, KEY_DATE_TIME, KEY_DATE_ADDED, KEY_REPEATING}, KEY_ROWID + "=" + rowId, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
     ...
     */
    public boolean updateReminder(long rowId, String title, String body, long reminderDateTime, long repeating) {
        ContentValues args = new ContentValues();
        args.put(KEY_TITLE, title);
        args.put(KEY_BODY, body);
        args.put(KEY_REPEATING, repeating);
