...
public class EasyVideoPlayer extends FrameLayout implements IUserMethods, TextureView.SurfaceTextureListener,
        ...
        if (attrs != null) {
            ...
            try {
                ...
                if (restartDrawableResId != -1) {
                    mRestartDrawable = context.getResources().getDrawable(R.drawable.evp_action_restart);
                }
                if (playDrawableResId != -1) {
                    mPlayDrawable = context.getResources().getDrawable(R.drawable.evp_action_play);
                }
                if (pauseDrawableResId != -1) {
                    mPauseDrawable = context.getResources().getDrawable(R.drawable.evp_action_pause);
                }
    ...
    public void setRestartDrawableRes(@DrawableRes int res) {
        setRestartDrawable(getContext().getResources().getDrawable(res));
    }
    ...
    public void setPlayDrawableRes(@DrawableRes int res) {
        setPlayDrawable(getContext().getResources().getDrawable(res));
    }
    ...
    public void setPauseDrawableRes(@DrawableRes int res) {
        setPauseDrawable(getContext().getResources().getDrawable(res));
    }
